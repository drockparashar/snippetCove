        ...
        {snippets.length > 0 ? (
          ...
          <div className="text-center py-8 sm:py-12">
            <div className="inline-block p-2 sm:p-3 rounded-full bg-muted mb-3 sm:mb-4">
              <BookMarked className="h-5 w-5 sm:h-6 sm:w-6 text-muted-foreground" />
            </div>
            <h3 className="text-lg sm:text-xl font-medium mb-1 sm:mb-2">No saved snippets yet</h3>
            <p className="text-xs sm:text-sm text-muted-foreground mb-4 sm:mb-6">
              Browse snippets and save the ones you find useful
            </p>
            <Link href="/snippets">
